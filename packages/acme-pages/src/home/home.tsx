...
import { Button, Quote } from '@o6/design-system'
...
export default function Home() {
  ...
  return (
    <Page>
      ...
      <Text className="mb-4">
        Works in the same way as <Code>packages/o6-design-system</Code> but
      ...
      <Text className="mb-4">
        ...
        <Code>packages/o6-pages/src/home</Code> and imported by{' '}
      ...
      <Text variant="h2" className="mt-10 my-6">
        packages/o6-storybook
      </Text>
      <Text className="mb-4">
        This packages takes the stories in{' '}
        <Code>packages/o6-design-system</Code> and opens them in{' '}
